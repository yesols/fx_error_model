...
# removing any parameter makes it significantly worse
lm_sum <- summary(lm(f, fold))
loo_result <- loocv(f, fold)
print(c(lm_sum$adj.r.squared, loo_result$coverage, loo_result$med_upr_bd))
```
